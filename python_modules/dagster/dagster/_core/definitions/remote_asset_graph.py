...
class RemoteAssetNode(BaseAssetNode):
    ...
    def repository_selectors(self) -> Sequence[RepositorySelector]:
        return [node.selector for node in self.scoped_asset_nodes]
    ...
    def priority_repository_selector(self) -> "RepositorySelector":
        return self._priority_scoped_node.selector
    ...
    def from_repository_selectors_and_asset_node_snaps(
        ...
        asset_nodes_by_key = {
            key: RemoteAssetNode(
                ...
                scoped_asset_nodes=[
                    RepositoryScopedAssetNode(asset=asset, selector=selector)
                    for selector, asset in repo_node_pairs
                ],
